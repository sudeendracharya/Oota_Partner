...
class EditBankDetails extends StatefulWidget {
  EditBankDetails({Key? key}) : super(key: key);
...
class _EditBankDetailsState extends State<EditBankDetails> {
  ...
  Future<void> save() async {
    ...
    Provider.of<Authenticate>(context, listen: false)
      ...
      Provider.of<ApiCalls>(context, listen: false)
          .updateBankDetails(
              bankPaymentSetUp, bankPaymentSetUp['Profile'], token)
          .then((value) async {
  ...
  void initState() {
    ...
    bankPaymentSetUp['Bank_Name'] = data['BankName'];
    bankPaymentSetUp['BSB'] = data['BSB'];
    bankPaymentSetUp['Account_Number'] = data['AccountNumber'];
    bankPaymentSetUp['Profile'] = data['Profile_Id'];
    super.initState();
  }
  ...
  SingleChildScrollView paymentDetails(double width) {
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              initialValue: bankPaymentSetUp['Bank_Name'] ?? '',
                        ...
                        Container(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.symmetric(
                                horizontal: 12, vertical: 6),
                            child: TextFormField(
                              initialValue: bankPaymentSetUp['BSB'] ?? '',
                              decoration: const InputDecoration(
                                  hintText: 'Enter BSD',
                                  border: InputBorder.none),
                              validator: (value) {
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              initialValue:
                                  bankPaymentSetUp['Account_Number'] ?? '',
                              decoration: const InputDecoration(
